...
def align_face(filepath, output_size=1024, transform_size=4096, enable_padding=True):
    ...
    :return: PIL Image
    """
    ensure_checkpoint_exists("/data1/dxw_data/code/github/iccv2023/jojogan_3d/pretrained/dlibshape_predictor_68_face_landmarks.dat")
    predictor = dlib.shape_predictor("/data1/dxw_data/code/github/iccv2023/jojogan_3d/pretrained/dlibshape_predictor_68_face_landmarks.dat")
